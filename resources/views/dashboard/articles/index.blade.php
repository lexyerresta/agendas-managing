...
@section('container')
    ...
    <a href="/dashboard/articles/create" class="btn btn-primary mb-2">Buat Artikel Baru</a>
    <a href="{{ route('dashboard.archive') }}" class="btn btn-secondary mb-2">Artikel Diarsipkan</a>

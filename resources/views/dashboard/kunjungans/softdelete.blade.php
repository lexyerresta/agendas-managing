...
@section('container')
    ...
    <a href="/dashboard/kunjungans" class="btn btn-primary mb-2 me-3">Kembali Ke Permintaan Kunjungan</a>
            ...
            <tr>
                ...
                <td>
                    @if (!$kunjungan->tanggal_approve)
                        @can('admin')
                            <form action="{{ route('dashboard.kunjungans.restore', $kunjungan->id) }}" method="post" class="d-inline">
                                @method('post')
                                @csrf
                            ...
                            <form action="/dashboard/kunjungans/{{ $kunjungan->id }}/forcedelete" method="post" class="d-inline">
                                @method('delete')
                                @csrf

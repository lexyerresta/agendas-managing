...
class AdminCategoryController extends Controller
{
    ...
    public function unactive($id)
    {
        ...
        return redirect('/dashboard/categories')->with('success', 'Kategori berhasil dinonaktifkan.');
    }
    ...
    public function active($id)
    {
        ...
        return redirect('/dashboard/categories')->with('success', 'Kategori berhasil diaktifkan kembali.');
    }
}
